...
const Footer = () => {
  return (
    <footer className="w-full border-b-2 border-white bg-[#060417] text-white">
      {/* top footer */}
      ...
      <div className="text base flex w-full flex-col items-center gap-y-8 p-2 px-4 font-semibold lg:flex-row lg:justify-between">
        <div className="flex flex-col items-center gap-y-4 lg:w-1/3 lg:items-start">
          ...
          <div className=" mx-auto w-1/2 text-center text-xs lg:mx-0  lg:text-balance  lg:text-sm">
        ...
        <div className="flex items-center gap-x-6 lg:ml-auto lg:-translate-x-1/4 xl:-translate-x-full">
          <InstagramLogoIcon className="size-6 transition-all duration-300 ease-out hover:scale-125 hover:stroke-sky-200 hover:shadow-md" />
          <TwitterLogoIcon className="size-6 transition-all duration-300 ease-out hover:scale-125 hover:stroke-sky-200 hover:shadow-md" />
          <Facebook className="size-6 transition-all duration-300 ease-out hover:scale-125 hover:stroke-sky-200 hover:shadow-md" />
        </div>
